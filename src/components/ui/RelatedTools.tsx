...
export default function RelatedTools({ tools, currentSlug }: { tools: Tool[]; currentSlug: string }) {
  ...
  return (
    <section className="mt-16">
      <h2 className="font-display text-2xl font-bold text-slate-900 mb-6">Related Tools</h2>
        ...
        {filtered.map((tool, i) => (
          ...
          >
            ...
            <div>
              ...
              <div className="text-xs text-slate-500 mt-0.5 line-clamp-2">{tool.tagline}</div>
            </div>
          </Link>
        ))}
      </div>
